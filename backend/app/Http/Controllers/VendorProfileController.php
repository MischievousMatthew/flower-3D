...
class VendorProfileController extends Controller
{
    ...
    public function updatePaymentDetails(Request $request)
    {
        try {
            ...
            Log::error('Error updating payment details', ['error' => $e->getMessage(), 'user' => Auth::id()]);
    ...
    public function updateProductDetails(Request $request)
    {
        try {
            ...
            Log::error('Error updating product details', ['error' => $e->getMessage(), 'user' => Auth::id()]);
    ...
    public function updateDeliveryDetails(Request $request)
    {
        try {
            ...
            Log::error('Error updating delivery details', ['error' => $e->getMessage(), 'user' => Auth::id()]);
    ...
    public function updateGeneralInfo(Request $request)
    {
        try {
            ...
            Log::error('Error updating general info', ['error' => $e->getMessage(), 'user' => Auth::id()]);
