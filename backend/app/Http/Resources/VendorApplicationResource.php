...
class VendorApplicationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'formatted_payout_method' => $this->formatted_payout_method,
            'account_holder_name' => $this->account_holder_name,
            'account_number' => $this->getDecryptedAccountNumber(), // Decrypted account number
            'bank_name' => $this->bank_name,
            'billing_address' => $this->billing_address,
            'product_types' => $this->product_types,
            'price_range' => $this->price_range,
            'same_day_delivery' => $this->same_day_delivery,
            'formatted_same_day_delivery' => $this->formatted_same_day_delivery,
            'order_cutoff' => $this->order_cutoff,
            'delivery_handled_by' => $this->delivery_handled_by,
            'formatted_delivery_handler' => $this->formatted_delivery_handler,
